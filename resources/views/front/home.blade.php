        ...
        <div id="carouselExampleIndicators" class="carousel slide carousel-fade" data-bs-ride="carousel"
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <picture>
                        <source media="(max-width: 799px)" srcset="{{ asset('front_asset/images/carousel-1-m.jpg') }}" />
                        <source media="(min-width: 800px)" srcset="{{ asset('front_asset/images/carousel-1.jpg') }}" />
                        <img src="{{ asset('front_asset/images/carousel-1.jpg') }}" alt="" />
                    </picture>
                ...
                <div class="carousel-item">
                    ...
                    <picture>
                        <source media="(max-width: 799px)" srcset="{{ asset('front_asset/images/carousel-2-m.jpg') }}" />
                        <source media="(min-width: 800px)" srcset="{{ asset('front_asset/images/carousel-2.jpg') }}" />
                        <img src="{{ asset('front_asset/images/carousel-2.jpg') }}" alt="" />
                    </picture>
                ...
                <div class="carousel-item">
                    ...
                    <picture>
                        <source media="(max-width: 799px)" srcset="{{ asset('front_asset/images/carousel-3-m.jpg') }}" />
                        <source media="(min-width: 800px)" srcset="{{ asset('front_asset/images/carousel-3.jpg') }}" />
                        <img src="{{ asset('front_asset/images/carousel-2.jpg') }}" alt="" />
                    </picture>
                        ...
                        <div class="col-md-3">
                            <div class="card product-card">
                                ...
                                <div class="card-body text-center mt-3">
                                    <a class="h6 link" href="#">{{ $featuredProduct->title }}</a>
